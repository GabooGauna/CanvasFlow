...
- conservar archivos adjuntos PDF, Word y de texto plano asociados a su trabajo;
...
4. crear Cards con título, descripción, color y Attachments;
...
- Attachments PDF, Word y de texto plano asociados a Cards o Canvas;
...
La V1 será exitosa cuando un estudiante pueda completar un flujo real de organización y estudio con Projects, Boards, Columns, Cards y Canvas; adjuntar archivos PDF, Word y de texto plano; buscar contenido; reiniciar la aplicación sin perder datos y utilizarla sin conexión de manera estable.
